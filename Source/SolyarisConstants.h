...
#define vAppSite                        @"http://solyaris.cecinestpasparis.net"
...
#define iOS7     ([[[UIDevice currentDevice] systemVersion] compare:@"8.0" options:NSNumericSearch] == NSOrderedAscending)
